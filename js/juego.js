...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/bache.png', 130, 220, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 430, 440, 15, 30, 2),
    new Obstaculo('imagenes/auto_verde_derecha.png', 800, 230, 30, 15, 2),
    new Obstaculo('imagenes/bache.png', 750, 120, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 100, 480, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 130, 480, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 370, 80, 30, 30, 1),
    // new vidaExtra('imagenes/cherry.png',370,230,20,20,-2)
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie2.png',100,100,20,20,1,{
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie2.png',300,200,20,20,1,{
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie2.png',420,380,20,20,1,{
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie2.png',500,400,20,20,1,{
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie2.png',700,200,20,20,1,{
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieConductor('imagenes/pacman-fila.png',400,322,100,30,2,{
      desdeX: 50,
      hastaX: 850,
      desdeY: 0,
      hastaY: 577
    },'h'),
    new ZombieConductor('imagenes/pacman-fila-izq.png',644,0,30,100,3,{
      desdeX: 50,
      hastaX: 850,
      desdeY: 0,
      hastaY: 477
    },'v'),
    new ZombieConductor('imagenes/pacman-fila-der.png',675,0,30,100,5,{ 
      desdeX: 50,
      hastaX: 850,
      desdeY: 0,
      hastaY: 477
  ...
  obstaculoDeAyuda: [
    new vidaExtra('imagenes/cherry.png',370,230,20,20,-3)
  ]
}
...
Juego.iniciarRecursos = function() {
  Resources.load([
    ...
    'imagenes/pacman-izq.png',
    'imagenes/pacman-arriba.png',
    'imagenes/pacman-der.png',
    'imagenes/pacman-abajo.png',
...
Juego.capturarMovimiento = function(tecla) {
  ...
  if (tecla == 'izq') {
    movX = -velocidad;
    this.jugador.sprite = 'imagenes/pacman-izq.png';
    this.jugador.alto = 20;
    this.jugador.ancho = 20;

  }
  if (tecla == 'arriba') {
    movY = -velocidad;
    this.jugador.sprite = 'imagenes/pacman-arriba.png';
    this.jugador.alto = 20;
    this.jugador.ancho = 20;
  }
  if (tecla == 'der') {
    movX = velocidad;
    this.jugador.sprite = 'imagenes/pacman-der.png';
    this.jugador.alto = 20;
    this.jugador.ancho = 20;
  }
  if (tecla == 'abajo') {
    movY = velocidad;
    this.jugador.sprite = 'imagenes/pacman-abajo.png';
    this.jugador.alto = 20;
    this.jugador.ancho = 20;
  }
...
Juego.dibujar = function() {
  ...
  Dibujante.dibujarRectangulo('yellow',760,530,125,10);
  // Se recorren los obstaculos de la carretera pintandolos
  this.obstaculosCarretera.forEach(function(obstaculo) {
    Dibujante.dibujarEntidad(obstaculo);
  });

  this.obstaculoDeAyuda.forEach(function(vida){
    Dibujante.dibujarEntidad(vida)
  });
...
Juego.chequearColisiones = function(x, y) {
  ...
  this.obstaculoDeAyuda.forEach(function(vida){
    if (this.intersecan(vida, this.jugador, x, y)){
      vida.chocar();
      vida.desaparecer();
      this.obstaculoDeAyuda.pop();
      puedeMoverse = true;
    }
  }, this)
